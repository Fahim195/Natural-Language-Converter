...
namespace SMTV1.Methods.TrasferApproach
{
    class TransferAndGeneration_stg
    {       
        ...
        public void RemovingAmbiguity(string[] objects,string[] object_postags, string[] WORDS)
        {
            ...
            objectPart = aAmguitySolution.removePrepositionalAmbiguity(meaningDT,WORDS,POSTAGs,objects, object_postags,subject,verb);             
